...
const AlertModal = ({ closeModal, saveModal, vehicleName, vehicleModel, vehicleFuelType, vehicleStatus , setVehicleName, setVehicleModel,
                        setVehicleFuelType, setVehicleStatus}) => {
    return (
        ...
        <div className="modal-content">
            ...
            <div className="modal-footer">
                <button type="button" className="button" onClick={saveModal}>Save</button>
            </div>
        </div>
